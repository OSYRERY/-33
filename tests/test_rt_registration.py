...
class TestValidRegistrationRT:
    ...
    def open(self):
        self.driver = webdriver.Chrome('D:/chromedriver107')
...
# python -m pytest -v --driver Chrome --driver-path D:/chromedriver107 test_rt_authorization.py *--alluredir reports*
